...
static const u8 sDoorAnimPalettes_StartingTown[] = {12, 8, 12, 8, 11, 8, 8, 8};
...
static const struct DoorGraphics sDoorAnimGraphicsTable[] =
{
    ...
    {METATILE_StartingTown_Door_StartingTownOne,            DOOR_SOUND_NORMAL,  1, sDoorAnimTiles_Littleroot, sDoorAnimPalettes_StartingTown},
