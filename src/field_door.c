...
static const u8 sDoorAnimTiles_StartingTown[] = INCBIN_U8("graphics/door_anims/starting_town.4bpp");
...
static const u8 sDoorAnimPalettes_StartingTown[] = {12, 12, 8, 8, 8, 8, 8, 8};
...
static const struct DoorGraphics sDoorAnimGraphicsTable[] =
{
    ...
    {METATILE_StartingTown_Door_StartingTownOne,            DOOR_SOUND_NORMAL,  1, sDoorAnimTiles_StartingTown, sDoorAnimPalettes_StartingTown},
